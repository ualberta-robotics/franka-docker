...
class GripperState(metaclass=Metaclass_GripperState):
    ...
    def __init__(self, **kwargs):
        ...
        self.is_grasped = kwargs.get('is_grasped', bool())
    ...
    def __eq__(self, other):
        ...
        if self.width != other.width:
            return False
        if self.is_grasped != other.is_grasped:
            return False
        return True
    ...
    @builtins.property
    def is_grasped(self):
        """Message field 'is_grasped'."""
        return self._is_grasped

    @is_grasped.setter
    def is_grasped(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'is_grasped' field must be of type 'bool'"
        self._is_grasped = value
