...
bool franky_msgs__msg__joint_move__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("franky_msgs.msg._joint_move.JointMove", full_classname_dest, 37) == 0);
  }
  franky_msgs__msg__JointMove * ros_message = _ros_message;
  {  // relative
...
{
  /* NOTE(esteve): Call constructor of JointMove */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("franky_msgs.msg._joint_move");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointMove");
