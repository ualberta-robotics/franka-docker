...
#include "franky_msgs/msg/detail/cartesian_velocity__rosidl_typesupport_fastrtps_c.h"
...
using _CartesianVelocity__ros_msg_type = franky_msgs__msg__CartesianVelocity;
...
size_t get_serialized_size_franky_msgs__msg__CartesianVelocity(
  const void * untyped_ros_message,
...
static uint32_t _CartesianVelocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_franky_msgs__msg__CartesianVelocity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_franky_msgs
size_t max_serialized_size_franky_msgs__msg__CartesianVelocity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = franky_msgs__msg__CartesianVelocity;
    is_plain =
      (
...
static size_t _CartesianVelocity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_franky_msgs__msg__CartesianVelocity(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franky_msgs, msg, CartesianVelocity)() {
