...
franky_msgs__srv__BlockingCartesianMove_Request__init(franky_msgs__srv__BlockingCartesianMove_Request * msg)
{
  ...
  // target
  if (!franky_msgs__msg__CartesianMove__init(&msg->target)) {
    franky_msgs__srv__BlockingCartesianMove_Request__fini(msg);
    return false;
  }
  return true;
}
...
franky_msgs__srv__BlockingCartesianMove_Request__fini(franky_msgs__srv__BlockingCartesianMove_Request * msg)
{
  ...
  // target
  franky_msgs__msg__CartesianMove__fini(&msg->target);
}
...
franky_msgs__srv__BlockingCartesianMove_Request__are_equal(const franky_msgs__srv__BlockingCartesianMove_Request * lhs, const franky_msgs__srv__BlockingCartesianMove_Request * rhs)
{
  ...
  // target
  if (!franky_msgs__msg__CartesianMove__are_equal(
...
franky_msgs__srv__BlockingCartesianMove_Request__create()
{
  ...
  franky_msgs__srv__BlockingCartesianMove_Request * msg = (franky_msgs__srv__BlockingCartesianMove_Request *)allocator.allocate(sizeof(franky_msgs__srv__BlockingCartesianMove_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(franky_msgs__srv__BlockingCartesianMove_Request));
  bool success = franky_msgs__srv__BlockingCartesianMove_Request__init(msg);
  if (!success) {
...
franky_msgs__srv__BlockingCartesianMove_Request__Sequence__init(franky_msgs__srv__BlockingCartesianMove_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franky_msgs__srv__BlockingCartesianMove_Request * data = NULL;

  if (size) {
    data = (franky_msgs__srv__BlockingCartesianMove_Request *)allocator.zero_allocate(size, sizeof(franky_msgs__srv__BlockingCartesianMove_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = franky_msgs__srv__BlockingCartesianMove_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        franky_msgs__srv__BlockingCartesianMove_Request__fini(&data[i - 1]);
      }
...
franky_msgs__srv__BlockingCartesianMove_Request__Sequence__fini(franky_msgs__srv__BlockingCartesianMove_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      franky_msgs__srv__BlockingCartesianMove_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franky_msgs__srv__BlockingCartesianMove_Request__Sequence * array = (franky_msgs__srv__BlockingCartesianMove_Request__Sequence *)allocator.allocate(sizeof(franky_msgs__srv__BlockingCartesianMove_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = franky_msgs__srv__BlockingCartesianMove_Request__Sequence__init(array, size);
  if (!success) {
...
franky_msgs__srv__BlockingCartesianMove_Request__Sequence__destroy(franky_msgs__srv__BlockingCartesianMove_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    franky_msgs__srv__BlockingCartesianMove_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
franky_msgs__srv__BlockingCartesianMove_Request__Sequence__are_equal(const franky_msgs__srv__BlockingCartesianMove_Request__Sequence * lhs, const franky_msgs__srv__BlockingCartesianMove_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!franky_msgs__srv__BlockingCartesianMove_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  franky_msgs__srv__BlockingCartesianMove_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(franky_msgs__srv__BlockingCartesianMove_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    franky_msgs__srv__BlockingCartesianMove_Request * data =
      (franky_msgs__srv__BlockingCartesianMove_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franky_msgs__srv__BlockingCartesianMove_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          franky_msgs__srv__BlockingCartesianMove_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!franky_msgs__srv__BlockingCartesianMove_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franky_msgs__srv__BlockingCartesianMove_Response * msg = (franky_msgs__srv__BlockingCartesianMove_Response *)allocator.allocate(sizeof(franky_msgs__srv__BlockingCartesianMove_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(franky_msgs__srv__BlockingCartesianMove_Response));
  bool success = franky_msgs__srv__BlockingCartesianMove_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
franky_msgs__srv__BlockingCartesianMove_Response__destroy(franky_msgs__srv__BlockingCartesianMove_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    franky_msgs__srv__BlockingCartesianMove_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
franky_msgs__srv__BlockingCartesianMove_Response__Sequence__init(franky_msgs__srv__BlockingCartesianMove_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franky_msgs__srv__BlockingCartesianMove_Response * data = NULL;

  if (size) {
    data = (franky_msgs__srv__BlockingCartesianMove_Response *)allocator.zero_allocate(size, sizeof(franky_msgs__srv__BlockingCartesianMove_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = franky_msgs__srv__BlockingCartesianMove_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        franky_msgs__srv__BlockingCartesianMove_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
franky_msgs__srv__BlockingCartesianMove_Response__Sequence__fini(franky_msgs__srv__BlockingCartesianMove_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      franky_msgs__srv__BlockingCartesianMove_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franky_msgs__srv__BlockingCartesianMove_Response__Sequence * array = (franky_msgs__srv__BlockingCartesianMove_Response__Sequence *)allocator.allocate(sizeof(franky_msgs__srv__BlockingCartesianMove_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = franky_msgs__srv__BlockingCartesianMove_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
franky_msgs__srv__BlockingCartesianMove_Response__Sequence__destroy(franky_msgs__srv__BlockingCartesianMove_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    franky_msgs__srv__BlockingCartesianMove_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
franky_msgs__srv__BlockingCartesianMove_Response__Sequence__are_equal(const franky_msgs__srv__BlockingCartesianMove_Response__Sequence * lhs, const franky_msgs__srv__BlockingCartesianMove_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!franky_msgs__srv__BlockingCartesianMove_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  franky_msgs__srv__BlockingCartesianMove_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(franky_msgs__srv__BlockingCartesianMove_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    franky_msgs__srv__BlockingCartesianMove_Response * data =
      (franky_msgs__srv__BlockingCartesianMove_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franky_msgs__srv__BlockingCartesianMove_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          franky_msgs__srv__BlockingCartesianMove_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!franky_msgs__srv__BlockingCartesianMove_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
