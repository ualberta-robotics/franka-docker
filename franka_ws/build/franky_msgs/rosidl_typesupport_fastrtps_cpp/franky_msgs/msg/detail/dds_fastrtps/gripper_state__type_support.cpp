...
#include "franky_msgs/msg/detail/gripper_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const franky_msgs::msg::GripperState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  franky_msgs::msg::GripperState & ros_message)
{
  // Member: width
  cdr >> ros_message.width;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = franky_msgs::msg::GripperState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const franky_msgs::msg::GripperState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<franky_msgs::msg::GripperState *>(
    untyped_ros_message);
...
get_message_type_support_handle<franky_msgs::msg::GripperState>()
{
  return &franky_msgs::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franky_msgs, msg, GripperState)() {
  return &franky_msgs::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
