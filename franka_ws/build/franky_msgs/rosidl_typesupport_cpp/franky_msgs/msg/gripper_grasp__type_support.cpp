...
static const _GripperGrasp_type_support_symbol_names_t _GripperGrasp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franky_msgs, msg, GripperGrasp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, franky_msgs, msg, GripperGrasp)),
  }
};
...
{
  return &::franky_msgs::msg::rosidl_typesupport_cpp::GripperGrasp_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, franky_msgs, msg, GripperGrasp)() {
  return get_message_type_support_handle<franky_msgs::msg::GripperGrasp>();
}
