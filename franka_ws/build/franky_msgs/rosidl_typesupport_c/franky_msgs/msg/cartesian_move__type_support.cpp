...
static const _CartesianMove_type_support_symbol_names_t _CartesianMove_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franky_msgs, msg, CartesianMove)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franky_msgs, msg, CartesianMove)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franky_msgs, msg, CartesianMove)() {
  return &::franky_msgs::msg::rosidl_typesupport_c::CartesianMove_message_type_support_handle;
}
